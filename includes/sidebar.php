...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style= "background-color: lightblue;">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="spendsmartlogo.png" class="img" alt="img">
            </div>
...
?>
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="budget.php"><em class="fa fa-budget-today">&nbsp;</em>Budget</a></li>

            <li class="active"><a href="manage-budget.php"><em class="fa fa-manage-budget">&nbsp;</em>Manage Budget</a></li>
