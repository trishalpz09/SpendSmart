...
$tdate = date('Y-m-d');
$query6 = mysqli_query($con, "SELECT SUM(budget_today) as total_budget_today FROM tbbudget WHERE (date)='$tdate' && (userid='$userid');");
$result6 = mysqli_fetch_array($query6);
$budget_today = $result6['total_budget_today'];
?>
<!DOCTYPE html>
<html>
<head>
...
<hr>
        ...
        <div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $budget_today;?>" ><span class="percent"><?php if($budget_today == ""){
echo "0";
} else {
echo $budget_today;
}?></span>
